...
{
    public class TalksTextFileRepositoryTests : TalksRepositorySpecifications
    {
        [Fact]
        public override void shouldListAllTalksInRepository()
        {
            //Arrange
            var fileLocation = "../../../Conferences/talks.txt";
            var txtTalkMapper = new TextFileRepository(fileLocation);
            ...
            //Act
            var actualResult = txtTalkMapper.list();
            //Assert
